...
class SiteController extends Controller
{
    ...
    public function actionListing($category_id, $sub_category_id = null) //Category
    {
        $posts = Post::find()
            ->where(['category_id' => $category_id])
            ->andFilterWhere(['sub_category_id' => $sub_category_id])
            ->all();
    ...
    public function actionFavourite($id)
    {
        ...
        $favourite=Favourite::find()->andWhere(['user_id'=>$user_id,'post_id'=>$id,])->one();
        $model = Post::findOne(['id' => $id]);
        if(!empty($favourite))
        {
            $favourite->delete();
        ...
        {
            $favouritePost = new Favourite();
            $favouritePost->user_id = $user_id;
            $favouritePost->post_id = $id;
            $favouritePost->save();
            return $this->redirect(['view', 'id' => $model->id]);
        }
    }
